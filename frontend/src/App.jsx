...
function App() {
  ...
  const authRole = localStorage.getItem('role'); // Retrieve the userRole from localStorage

  return (
    <div className="font-outfit overflow-hidden">
      <ToastContainer />
      {/* Wrap the app with SocketProvider and pass userId and userRole */}
      <SocketProvider userId={authUserId} userRole={authRole}>
        <Routes>
