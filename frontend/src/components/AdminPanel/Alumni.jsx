...
const Alumni = () => {
  ...
  const fetchAlumni = async () => {
    try {
      ...
      // Set all alumni without filtering out the verified ones
    ...
    <div className="alumni-list">
      {alumniList.length === 0 ? (
        ...
        alumniList.map((alumni) => (
          <div key={alumni.id} className="alumni-card p-4 border rounded mb-4">
            ...
            {!alumni.verified ? (
              ...
              <span className="mt-4 inline-block bg-blue-500 text-white py-2 px-4 rounded opacity-75 cursor-not-allowed">
                Verified
              </span>
            )}
          </div>
