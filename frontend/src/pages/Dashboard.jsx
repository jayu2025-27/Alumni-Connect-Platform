...
function Dashboard() {
  ...
  const handleMessageClick = (user) => {
    ...
    setActiveCard(""); // Clear active card if any
  };
  ...
  const renderContent = () => {
    switch (activeSection) {
      ...
      case "events":
        return <EventsList />;
      case "network":
        return <Network onMessageClick={handleMessageClick} />;
      case "open-source":
        return <OpenSource />;
      case "messages":
        return <Messages loggedInUser={loggedInUser} initialSelectedUser={selectedUserForChat} />;
      default:
