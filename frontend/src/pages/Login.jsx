...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const { success, message, token, fullname, profilePhoto, id, _id } = result;
            ...
            if (success) {
                ...
                localStorage.setItem('userId', finalUserId); // Store userId properly
